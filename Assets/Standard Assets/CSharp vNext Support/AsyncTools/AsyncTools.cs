...
public static class AsyncTools
{
	...
	private static readonly Awaiter editorUpdateAwaiter = new SynchronizationContextAwaiter(UnityScheduler.EditorUpdateScheduler?.Context);
	...
	/// </summary>
	public static Awaiter ToEditorUpdate() => editorUpdateAwaiter;
