...
public class AlloyFloatParser : AlloyFieldParser {
    ...
    private void SetSectionOption(AlloyFieldDrawer retDrawer, AlloyToken argToken) {
                ...
                foreach (var token in collectionToken.SubTokens) {
                    ...
                    if (arg != null && arg.ArgumentName == "Color") {
                        ...
                        if (value != null) {
                            ...
                            if (hueIndex > -0.1f)
                                sectionDrawer.Color = Color.HSVToRGB((hueIndex / AlloyUtils.MaxSectionColorIndex) * 0.8f, 0.75f, 0.5f);
                        }
                        else {
