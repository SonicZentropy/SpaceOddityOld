...
public class AlloyMaterialMapChannelPacker : EditorWindow {
    ...
    public static MaterialMapChannelPackerDefinition GlobalDefinition {
        get {
            if (s_definition == null) {
                string path = "Assets/Standard Assets/Alloy/Scripts/MaterialMapChannelPacker/Config/_PackerDefinition.asset";
                s_definition =
    ...
    [MenuItem(AlloyUtils.MenubarPath + "Material Map Channel Packer", false, 0)]
    ...
    public bool BaseGUI() {
        ...
        isValid = DrawPackedMapDefinition(Target.PackMode);
