...
#ifndef A_FEATURES_TRIPLANAR_CGINC
#define A_FEATURES_TRIPLANAR_CGINC
    ...
    inout ASurface s) 
{
    ...
    ASplat sp0 = aNewSplat();
        ...
        aTriPlanarZ(sp3, sc, A_SAMPLER_INPUT(_QuaternaryMainTex), _QuaternaryMaterialMap, _QuaternaryBumpMap, _QuaternaryOcclusion, _QuaternaryBumpScale);
...
#endif // A_FEATURES_TRIPLANAR_CGINC
