    ...
    inout ASurface s)
{
    ...
    ASplat sp = aNewSplat(sc, A_SAMPLER_INPUT(_MainTex2), _MaterialMap2, _BumpMap2, _Color2, _BaseColorVertexTint2, _Metallic2, _Specularity2, _SpecularTint2, _Roughness2, _Occlusion2, _BumpScale2);
