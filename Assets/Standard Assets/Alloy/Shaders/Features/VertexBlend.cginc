    ...
    inout ASurface s)
{
    ...
    ASplat sp0 = aNewSplat(sc, A_SAMPLER_INPUT(_Splat0), _MaterialMap0, _Normal0, _Splat0Tint, 0.0h, _Metallic0, _SplatSpecularity0, _SplatSpecularTint0, _SplatRoughness0, _SplatOcclusion0, _SplatBumpScale0);
    ASplat sp1 = aNewSplat(sc, A_SAMPLER_INPUT(_Splat1), _MaterialMap1, _Normal1, _Splat1Tint, 0.0h, _Metallic1, _SplatSpecularity1, _SplatSpecularTint1, _SplatRoughness1, _SplatOcclusion1, _SplatBumpScale1);
    ASplat sp2 = aNewSplat(sc, A_SAMPLER_INPUT(_Splat2), _MaterialMap2, _Normal2, _Splat2Tint, 0.0h, _Metallic2, _SplatSpecularity2, _SplatSpecularTint2, _SplatRoughness2, _SplatOcclusion2, _SplatBumpScale2);

    #ifdef A_ALPHA_SPLAT_ON
        half4 splatControl = s.vertexColor;
        ASplat sp3 = aNewSplat(sc, A_SAMPLER_INPUT(_Splat3), _MaterialMap3, _Normal3, _Splat3Tint, 0.0h, _Metallic3, _SplatSpecularity3, _SplatSpecularTint3, _SplatRoughness3, _SplatOcclusion3, _SplatBumpScale3);
