    ...
    AVertex v)
{
    ...
    o.uv_MainTex = A_TEX_TRANSFORM_SCROLL_SPIN(_MainTex, v.texcoord);
    
#ifdef _PARTICLE_EFFECTS_ON
    o.uv_ParticleEffectMask1 = A_TEX_TRANSFORM_SCROLL_SPIN(_ParticleEffectMask1, v.texcoord);
    o.uv_ParticleEffectMask2 = A_TEX_TRANSFORM_SCROLL_SPIN(_ParticleEffectMask2, v.texcoord);
#endif
