...
#define A_ZERO (half3(0.0h, 0.0h, 0.0h))

/// Multi-component zero.
#define A_ZERO4 (half4(0.0h, 0.0h, 0.0h, 0.0h))

/// Multi-component one.
#define A_ONE (half3(1.0h, 1.0h, 1.0h))

/// Multi-component one.
#define A_ONE4 (half4(1.0h, 1.0h, 1.0h, 1.0h))

/// Color Black.
#define A_BLACK A_ZERO

/// Multi-component zero.
#define A_BLACK4 A_ZERO4

/// Color White.
#define A_WHITE A_ONE

/// Multi-component one.
#define A_WHITE4 A_ONE4

/// X-Axis normal.
#define A_AXIS_X (half3(1.0h, 0.0h, 0.0h))

/// Y-Axis normal.
#define A_AXIS_Y (half3(0.0h, 1.0h, 0.0h))

/// Z-Axis normal.
#define A_AXIS_Z (half3(0.0h, 0.0h, 1.0h))

/// Flat normal in tangent space.
#define A_FLAT_NORMAL A_AXIS_Z
...
#define A_SAMPLER_INPUT(name) name, name##_ST, name##Velocity, name##UV
