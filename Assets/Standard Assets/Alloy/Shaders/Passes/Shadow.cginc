...
#if defined(A_ALPHA_BLENDING_ON) && !((SHADER_TARGET < 30) || defined (SHADER_API_MOBILE) || defined(SHADER_API_GLES) || defined(SHADER_API_D3D11_9X) || defined (SHADER_API_PSP2))
	#define UNITY_STANDARD_USE_DITHER_MASK 1
#endif

// Need to output UVs in shadow caster, since we need to sample texture and do clip/dithering based on it
#if !defined(INSTANCING_ON) && !defined(A_SHADOW_SURFACE_ON) && !defined(_ALPHATEST_ON) && !defined(A_ALPHA_BLENDING_ON)
