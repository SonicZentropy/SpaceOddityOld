...
namespace Forge3D
{
    public class F3DMissileLauncher : MonoBehaviour
    {
        ...
        void Start()
        {
	        ...
	        missileTypeLabel.text = "Missile type: Dumbfire";
        }
        ...
        // Precesses input for launching missile
        void ProcessInput()
        {
            if (Input.GetMouseButtonDown(0))
            {
                Transform tMissile = Instantiate(missilePrefab,
                    transform.position + Vector3.up*2, Quaternion.identity, null);
            ...
            else if (Input.GetKeyDown(KeyCode.Alpha2))
            {
	            ...
	            missileTypeLabel.text = "Missile type: Homing";
            }
            else if (Input.GetKeyDown(KeyCode.Alpha3))
            {
                missileType = F3DMissile.MissileType.Predictive;
	            missileTypeLabel.text = "Missile type: PID";
            }
        }
