...
public class h2iTransform : h2i {
    ...
    public h2iTransform Read(int stamp) {
		...
		//Prevent error when a transform'd object is parented to the UI
	    if (!info.t) info.t = info.go.GetComponent<RectTransform>();
...
public class h2iComponent : h2i {
    ...
    public List<UnityEngine.Component> components;
    ...
    public h2iComponent Read(int stamp) {
        ...
        var list = info.go.GetComponents<UnityEngine.Component>();
