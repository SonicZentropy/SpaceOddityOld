...
public static class TransformX {
    ...
    public static List<T> xGetChildren<T>(this UnityEngine.Component t, bool deep = false, bool includeMe = false,
        bool activeOnly = false) where T : UnityEngine.Component {
    ...
    public static List<T> xGetSibling<T>(this UnityEngine.Component t, bool includeMe = false, bool activeOnly = false)
    ...
    public static void xForeachChild<T>(this Transform p, Func<T, bool> action, bool deep = false) where T : UnityEngine.Component {
