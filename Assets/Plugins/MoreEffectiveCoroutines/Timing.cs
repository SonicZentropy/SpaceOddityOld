...
namespace MEC
{
    ...
    public class Timing : MonoBehaviour
    {
        ...
        private struct ProcessIndex : System.IEquatable<ProcessIndex>
        {
            ...
            {
                return (((int)seg - 2) * (int.MaxValue / 2)) + i;
            }
        }
