...
namespace Zen.Weapons.Lightsaber
{
    ...
    public class LightSaber_engine : MonoBehaviour
    {
        ...
        //Singleton
        public static LightSaber_engine Instance { get; private set; }
        ...
        protected void Awake()
        {
            ...
            {
                Debug.LogError("More than one instance of LightSaber_engine is active. Disabling additional instance");
                this.enabled = false;
            }
        }
